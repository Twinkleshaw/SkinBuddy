    ...
    return (
      <div className="fixed inset-0 bg-black/70 bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white p-6 rounded-md w-full max-w-[400px] relative">
          ...
          <h2 className="text-xl font-semibold mb-6 text-center text-[#333]" style={{ fontFamily: "Georgia, serif" }}>
            Create an Account
          </h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="w-full bg-[#f18526] text-white py-2 rounded-md hover:bg-[#f18527] transition">
              Sign Up
            </button>
          </form>
